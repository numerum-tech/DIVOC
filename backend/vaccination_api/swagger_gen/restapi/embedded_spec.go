...
func init() {
  ...
  "securityDefinitions": {
    "hasRole": {
      "type": "oauth2",
      "flow": "accessCode",
      "authorizationUrl": "https://divoc.togosafe.gouv.tg/keycloak/auth/realms/divoc/protocol/openid-connect/auth",
      "tokenUrl": "https://divoc.togosafe.gouv.tg/keycloak/auth/realms/divoc/protocol/openid-connect/token",
      "scopes": {
